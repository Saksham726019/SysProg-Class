...
https://github.com/Saksham726019/SysProg-Class

4. Briefly describe what you want to get out of this class.
I want to be more proficient in C programming. I have already taken CS-260, but with this class, learning systems programming through C, I hope to understand this class both theoreticaly and practically.

5. Briefly describe any concerns you might be having with being successful in this class (if any).
My concern is if I will be able to manage time. With 18 credits and a part time, I hope to finish everything on time.